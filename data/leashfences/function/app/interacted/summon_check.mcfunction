...
$execute as @e[type=interaction,tag=leashfences.interaction,nbt={data:{player_UUID:$(UUID)}}] at @s run data modify entity @e[type=leash_knot,tag=leashfences.leash_knot,tag=leashfences.leash_knot_new,dx=0,dy=0,dz=0,limit=1] data.leash_entity_UUID set from entity @e[type=parrot,tag=leashfences.dummy_leash_entity,tag=leashfences.dummy_leash_entity_new,dx=0,dy=0,dz=0,limit=1] UUID
$execute as @e[type=interaction,tag=leashfences.interaction,nbt={data:{player_UUID:$(UUID)}}] at @s run data modify entity @e[type=parrot,tag=leashfences.dummy_leash_entity,tag=leashfences.dummy_leash_entity_new,dx=0,dy=0,dz=0,limit=1] data.leash_entity_UUID set from entity @e[type=parrot,tag=leashfences.leash_entity,tag=leashfences.leash_entity_new,dx=0,dy=0,dz=0,limit=1] UUID
$execute as @e[type=interaction,tag=leashfences.interaction,nbt={data:{player_UUID:$(UUID)}}] at @s run data modify entity @e[type=parrot,tag=leashfences.leash_entity,tag=leashfences.leash_entity_new,dx=0,dy=0,dz=0,limit=1] data.leash_entity_UUID set from entity @e[type=parrot,tag=leashfences.dummy_leash_entity,tag=leashfences.dummy_leash_entity_new,dx=0,dy=0,dz=0,limit=1] UUID

tag @e[type=leash_knot,tag=leashfences.leash_knot,tag=leashfences.leash_knot_new] remove leashfences.leash_knot_new
tag @e[type=parrot,tag=leashfences.dummy_leash_entity,tag=leashfences.dummy_leash_entity_new] remove leashfences.dummy_leash_entity_new
tag @e[type=parrot,tag=leashfences.leash_entity,tag=leashfences.leash_entity_new] remove leashfences.leash_entity_new
