...
$execute as @e[type=interaction,tag=leash_fences.interaction,nbt={data:{player_UUID:$(UUID)}}] at @s run data modify entity @e[type=leash_knot,tag=leash_fences.leash_knot,tag=leash_fences.leash_knot_new,dx=0,dy=0,dz=0,limit=1] data.leash_entity_UUID set from entity @e[type=copper_golem,tag=leash_fences.dummy_leash_entity,tag=leash_fences.dummy_leash_entity_new,dx=0,dy=0,dz=0,limit=1] UUID
$execute as @e[type=interaction,tag=leash_fences.interaction,nbt={data:{player_UUID:$(UUID)}}] at @s run data modify entity @e[type=copper_golem,tag=leash_fences.dummy_leash_entity,tag=leash_fences.dummy_leash_entity_new,dx=0,dy=0,dz=0,limit=1] data.leash_entity_UUID set from entity @e[type=copper_golem,tag=leash_fences.leash_entity,tag=leash_fences.leash_entity_new,dx=0,dy=0,dz=0,limit=1] UUID
$execute as @e[type=interaction,tag=leash_fences.interaction,nbt={data:{player_UUID:$(UUID)}}] at @s run data modify entity @e[type=copper_golem,tag=leash_fences.leash_entity,tag=leash_fences.leash_entity_new,dx=0,dy=0,dz=0,limit=1] data.leash_entity_UUID set from entity @e[type=copper_golem,tag=leash_fences.dummy_leash_entity,tag=leash_fences.dummy_leash_entity_new,dx=0,dy=0,dz=0,limit=1] UUID

tag @e[type=leash_knot,tag=leash_fences.leash_knot,tag=leash_fences.leash_knot_new] remove leash_fences.leash_knot_new
tag @e[type=copper_golem,tag=leash_fences.dummy_leash_entity,tag=leash_fences.dummy_leash_entity_new] remove leash_fences.dummy_leash_entity_new
tag @e[type=copper_golem,tag=leash_fences.leash_entity,tag=leash_fences.leash_entity_new] remove leash_fences.leash_entity_new
